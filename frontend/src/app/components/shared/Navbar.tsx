...
export const Navbar = () => {
  ...
  // Mảng định nghĩa các liên kết điều hướng cập nhật dựa theo frontend của bạn
  const navLinks = [
    { name: "Home", path: "/" },
    ...
    <nav className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/80 backdrop-blur-md transition-colors dark:border-white/10 dark:bg-[#0B0F19]/80">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-10">
          ...
          {/* MENU ĐIỀU HƯỚNG GIỮA (HIỂN THỊ TRÊN DESKTOP) */}
        ...
        <div className="flex items-center gap-3">
          ...
          {isLoggedIn ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 rounded-2xl p-1.5 border border-gray-200 bg-white shadow-xl dark:border-white/10 dark:bg-[#0B0F19]">
                ...
                {/* THÊM MỚI: Nút dẫn đến Profile Dashboard */}
          ...
          {/* NÚT TOGGLE MENU MOBILE (HIỂN THỊ KHI MÀN HÌNH NHỎ) */}
          <button 
      ...
      {/* DROPDOWN MENU CHO MOBILE CHUẨN UX */}
      {mobileMenuOpen && (
